...
**Cerina's Opening**: "hey is /Users/cerinawithasea/TelegramUploader/history_forwarder.py the one that send my last 1000 uploads to -1002485184608"  
...
**"i have a idea - cerina2 belongs to -1002314190734 that has the files also"**
...
```bash
python3 history_forwarder.py --source -1002314190734 --dest -1002485184608 --count 10 --files-only
```

Results:
- ✅ **Source**: "Cerina's Secret Vault" (-1002314190734)
- ✅ **Destination**: "Just Cerina and her books" (-1002485184608)
...
*P.S. - The history forwarder is ready to send all 1000 files whenever you want to run the full batch. Just use: `python3 history_forwarder.py --source -1002314190734 --dest -1002485184608 --count 1000 --files-only`*
